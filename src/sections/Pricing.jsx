    ...
    return (<section>
        <Element name="pricing">
            <div className="container">
                ...
                {/*  pricing section*/}
                <div
                    className="scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6 justify-center">
                    {plans.map((plan, index) => (
                        <div key={plan.id}
                            ...
                            <div
                                className={clsx("body-1 relative z-2 mb-10 w-full border-b-s2 pb-9 text-center text-p4", index === 1 && "border-b",)}
                            >
                                {plan.caption}
                            </div>

                            <ul className="mx-auto space-y-4 xl:px-7">
                                {plan.features.map((feature) => (<li
                                    key={feature}
